...
if (key_index == -1):
    print('Linear search: %d was not found with %d comparisons.' %
          (key, comparisons))
else:
    print('Linear search: Found %d at index %d with %d comparisons.' %
          (key, key_index, comparisons))

# Test binary search
key_index, comparisons = binary_search(numbers, key)
if (key_index == -1):
    print('Binary search: %d was not found with %d comparisons.' %
          (key, comparisons))
else:
    print('Binary search: Found %d at index %d with %d comparisons.' %
          (key, key_index, comparisons))
